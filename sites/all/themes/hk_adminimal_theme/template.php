 ...
 */
function hk_adminimal_preprocess_maintenance_page(&$vars) {
 ...
 */
function hk_adminimal_preprocess_page(&$vars) {
 ...
 */
function hk_adminimal_node_add_list($variables) {
 ...
 */
function hk_adminimal_adminimal_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function hk_adminimal_tablesort_indicator($variables) {
 ...
 */
function hk_adminimal_css_alter(&$css) {
 ...
 */
function hk_adminimal_js_alter(&$javascript) {
 ...
 */
function hk_adminimal_admin_block($variables) {
 ...
 * Adding classes to the administration blocks see issue #1869690.
 */
function hk_adminimal_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
 ...
 */
function hk_adminimal_table($variables) {
