 ...
 * Adds path variables.
 */
function hk_subdomain_preprocess_html(&$variables, $hook) {
  // Add variables and paths needed for HTML5 and responsive support.
  $variables['base_path'] = base_path();
  $variables['path_to_bear_skin'] = drupal_get_path('theme', 'hk_theme');
}

function hk_subdomain_preprocess_page(&$variables) {
 ...
 */
function hk_subdomain_links($variables) {
...
function hk_subdomain_links__locale_block($variables) {
  global $language;
 ...
 */
function hk_subdomain_preprocess_views_view_unformatted(&$vars) {
  $view = $vars['view'];
 ...
 */
 function hk_subdomain_language_negotiation_info_alter(&$negotiation_info) {
     unset($negotiation_info[LOCALE_LANGUAGE_NEGOTIATION_BROWSER]['cache']);
 }

function hk_subdomain_preprocess_views_view(&$vars) {
 ...
 */
function hk_subdomain_wysiwyg_editor_settings_alter(&$settings, $context) {
...
function hk_subdomain_process_token_tree(&$variables) {
