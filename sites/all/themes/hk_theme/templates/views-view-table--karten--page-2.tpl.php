 ...
 */
?>
<div class="apartment-list-parent shadow-apartment-list-parent">
  <div class="apartment-list-sub-parent shadow-apartment-list-sub-parent">
    <table <?php if ($classes) { print 'class="'. $classes . ' shadow-apartment grey-shadow-apartment" '; } ?><?php print $attributes; ?>>
