...
<div<?php if ($classes_array[$id]) { print ' class="' . $classes_array[$id] .'"';  } ?>>
  <div class="popup-content">
    <div class="apart">
        ...
        <span class="id"><?php print $row['field_object_ref_field_objektid_nunumeric']."-".$row['field_apart_no']; ?></span>
        ...
        <span><a class="more" href="/node/<?php print $row['nid']; ?>">Details</a></span>
    </div>
  </div>
</div>  
<?php endforeach; ?>
